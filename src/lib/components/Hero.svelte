<script lang="ts">
    ...
    const socialLinks = [
        ...
        {
            name: "Email",
            url: "mailto:mahmudul96@gmail.com",
...
<section id="home" class="hero">
    <div class="container">
        <div class="hero-content" class:visible={mounted}>
            ...
            <h1 class="hero-name">Mahmudul Hasan</h1>
            <h2 class="hero-title">Senior Software Engineer</h2>

            <p class="hero-description">
                I build robust, scalable applications with a decade of expertise
                in PHP, Laravel, and modern web architectures. Currently focused
                on fintech solutions and system architecture.
            </p>
